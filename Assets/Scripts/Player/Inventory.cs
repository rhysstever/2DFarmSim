...
public class Inventory : MonoBehaviour
{
    ...
    /// <summary>
    /// Converts a slot number to an index
    /// </summary>
    ...
    public void AddToInventory(GameObject newObject)
	{
		...
		else
		{
            ...
            GameObject.Find("gameManager").GetComponent<UIManager>().AddImageToInventory(newObject, index);
		}
	}

    /// <summary>
    /// Finds the next open slot in the inventory
    /// </summary>
    ...
    public GameObject RemoveFromInventory(int slot)
    {
        ...
        GameObject.Find("gameManager").GetComponent<UIManager>().RemoveImageFromInventory(index);
